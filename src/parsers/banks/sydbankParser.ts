// 1 fil - 1 funktion
// parsers/banks/sydbankParser.ts – Dedikeret parser kun til Sydbank CSV (header + specifikke kolonner)

import Papa from 'papaparse';
import type { Transaction } from '../csvParser';

export const parseSydbankCSV = (csvText: string): Transaction[] => {
...
// Intern row-parser kun til Sydbank-formatet
const parseSydbankRow = (row: Record<string, any>): Transaction | null => {
