// 1 fil - 1 funktion
// parsers/banks/jyskeBankParser.ts – Dedikeret parser kun til Jyske Bank CSV (header + specifikke kolonner)

import Papa from 'papaparse';
import type { Transaction } from '../csvParser';

export const parseJyskeBankCSV = (csvText: string): Transaction[] => {
...
// Intern row-parser kun til Jyske Bank-formatet
const parseJyskeBankRow = (row: Record<string, any>): Transaction | null => {
