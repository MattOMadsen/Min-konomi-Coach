// 1 fil - 1 funktion
// parsers/banks/sparnordParser.ts – Dedikeret parser kun til Spar Nord CSV (header + specifikke kolonner)

import Papa from 'papaparse';
import type { Transaction } from '../csvParser';

export const parseSparNordCSV = (csvText: string): Transaction[] => {
...
// Intern row-parser kun til Spar Nord-formatet
const parseSparNordRow = (row: Record<string, any>): Transaction | null => {
